  ...
  <div class="box span12">
      ...
      <div class="box-content">
          ...
          if($got_gallery_pic==TRUE)
          {
            ...
            echo "NOTE: You have atleast one gallery pic for this item.";
            echo "</div>";
          ...
          ?>
          <a href="<?= base_url() ?>item_galleries/update_group/<?= $update_id ?> "> <button type="button" class="btn btn-<?= $gallery_btn_theme ?>">Item Gallery</button></a>
