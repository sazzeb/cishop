...
<a href="<?= base_url() ?>item_galleries/upload_image/<?= $parent_id ?>" role="button" class="btn btn-info" data-toggle="modal">Upload PIcture</a>
...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon file"></i><span class="break"></span>Existing Pictures</h2>
			<div class="box-icon">
