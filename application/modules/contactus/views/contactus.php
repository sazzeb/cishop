                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="telnum" name="telnum" value="<?= $telnum ?>" class="form-control" id="telnum" placeholder="Enter telephone number"/></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
                                Message</label>
                            <textarea name="message" id="message" class="form-control" rows="9" cols="25" placeholder="Message"><?= $message ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
