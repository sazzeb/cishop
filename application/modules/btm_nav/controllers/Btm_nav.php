...
function submit_create()
{
    ...
    }elseif($submit=='Submit')
    {
        ...
        $data['priority'] = 0;
        $this->_insert($data);
        $flash_msg = "You have successfully added a new page to the bottom";
...
function _draw_create_modal()
{
    ...
    $data['options_for_dropdwon'] = $this->_get_dropdown_options($selected_options);
