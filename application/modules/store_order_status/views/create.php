        ...
        <div class="box-content">
          ...
          ?>
            <form class="form-horizontal" method="post" action="<?= $form_location ?>">
              <fieldset>
                <div class="control-group"> <label class="control-label" for="typeahead">Status Order Option</label> <div class="controls"> <input type="text" class="span6" name="status_title" value="<?= $status_title ?>"> </div> </div>
