...
function _get_status_status($update_id)
{
...
function _transfer_frombasbet($customer_sesssion_id)
{
    ...
    $mysql_query = "delete from store_basket where session_id = '$customer_sesssion_id'";
